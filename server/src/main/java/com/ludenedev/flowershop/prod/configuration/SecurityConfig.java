package com.ludenedev.flowershop.prod.configuration;
...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList("http://localhost:9000", "http://localhost:8080 ","http://localhost:5173"));
